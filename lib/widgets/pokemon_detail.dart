  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: AppColors.surface, // slate-950 roughly
            ...
            children: [
              IconButton(
                icon: Icon(
                  ...
                  color: isInTeam ? AppColors.primary : Colors.white.withValues(alpha: 0.5),
                ),
              ...
              IconButton(
                icon: Icon(
                  ...
                  color: isFavorite ? AppColors.secondary : Colors.white.withValues(alpha: 0.5),
                ),
