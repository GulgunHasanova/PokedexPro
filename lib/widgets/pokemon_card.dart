...
class PokemonCard extends StatelessWidget {
  ...
  Widget _buildGlow(Color primaryColor) {
    return Positioned(
      top: -20,
      right: -20,
      child: Container(
          ...
          children: [
            GestureDetector(
              ...
              child: Icon(
                ...
                size: 20,
                color: isInTeam ? AppColors.primary : Colors.white.withValues(alpha: 0.4),
              ),
            ),
            ...
            GestureDetector(
              ...
              child: Icon(
                ...
                size: 20,
                color: isFavorite ? AppColors.secondary : Colors.white.withValues(alpha: 0.4),
              ),
            ),
          ],
        )
